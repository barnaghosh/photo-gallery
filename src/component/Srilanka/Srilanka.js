...
export class Srilanka extends Component {
         ...
         if(this.props.items !==null){
             ...
             item= (
                 <div style={{margin:'40px 0px'}} >
                     <h1 style={{textAlign:'center'}}>Srilanka's Tourist Attractions</h1>
...
export default connect(mapStateToProps,mapDispatchToProps) (Srilanka)
